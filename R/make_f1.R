...
make_f1 <- function(p1,p2,g_map,c=10){
  if(runif(1)>=0.5){
  ...
  f1=chrom_init(c=c,g_map,h1_breakpoints = h1_breakpoints,h1_donors=h1_donors,h2_breakpoints=h2_breakpoints,h2_donors=h2_donors)
  return(f1)
}
